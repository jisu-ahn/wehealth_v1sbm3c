...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/tensorflow/recommend_exercise/form2.do' method='GET'>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                ...
                <TD class='td_image'>
                    <img id='img2' src="/recommend_exercise/images/v21.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_exercise/images/v31.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_exercise/images/v41.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_exercise/images/v51.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
