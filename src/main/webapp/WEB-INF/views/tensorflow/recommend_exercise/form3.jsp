...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/tensorflow/recommend_exercise/form4.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend_exercise/images/v13.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_exercise/images/v23.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_exercise/images/v33.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_exercise/images/v43.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_exercise/images/v53.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
