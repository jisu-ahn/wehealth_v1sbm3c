...
<DIV class="container">
    ...
    <form id='frm' name='frm' action='/tensorflow/recommend_exercise/form3.do' method='GET'>
        <input type='hidden' name='step1' value='${param.step1 }'>
        <br>
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend_exercise/images/v12.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_exercise/images/v22.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_exercise/images/v32.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_exercise/images/v42.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img5' src="/recommend_exercise/images/v52.jpg" style='float:left; height: 200px'>
                </TD>
            </TR>
            <TR>
                <TD class='td_radio'>
