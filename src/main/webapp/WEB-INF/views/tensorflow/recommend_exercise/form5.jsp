...
<body>
<DIV class="container">
    <H1>5/5 단계입니다. 마지막입니다.</H1>
    <DIV id='panel' style='display: none; margin: 10px auto; width: 90%;'></DIV>

    <form id='frm' name='frm' action='/tensorflow/recommend_exercise/end.do' method='GET'>
        ...
        <TABLE style='margin: 0px auto;'>
            <TR>
                <TD class='td_image'>
                    <img id='img1' src="/recommend_exercise/images/v15.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img2' src="/recommend_exercise/images/v25.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img3' src="/recommend_exercise/images/v35.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
                    <img id='img4' src="/recommend_exercise/images/v45.jpg" style='float:left; height: 200px'>
                </TD>
                <TD class='td_image'>
