...
<head>
    ...
    <link rel="stylesheet" 
href="//netdna.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
...
<body>
    <img src="/chatbot/images/background.jpg" 
         style='position: fixed; top: 17%; left: 8%; opacity: 0.2; width: 81%; height: 71%;'>
    ...
    <div id="container" class="container">
        ...
        <div style='margin: 0px auto;'>
            메시지
            <input id="chatting" name='msg' placeholder="보내실 메시지를 입력하세요."
                   value="줄넘기를 1개 주문하고 싶습니다."></th>
